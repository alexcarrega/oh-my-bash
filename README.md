...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/alexcarrega/oh-my-bash/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/alexcarrega/oh-my-bash/master/tools/install.sh -O -)"
```
